...
<footer class="container">
    <div class="wrapper is-size-6">
        ...
        <div class="wrapped">
            <p>The DOT Precipitation Frequency Tool was developed by the <a href="https://uaf-snap.org">Scenarios Network for Alaska & Arctic Planning (SNAP)</a> and <a href="http://www.neptuneinc.org/">Neptune Inc.</a> from data provided by the National Weather Service Atlas 14 system and climitalogical forecast data generated by Peter Bieniek of UAF. This website was developed by the <a href="https://uaf-snap.org/">Scenarios Network for Alaska & Arctic Planning</a>, a research group at the <a href="https://uaf-iarc.org/">International Arctic Research Center (IARC)</a> at the <a href="https://uaf.edu/uaf/">University of Alaska Fairbanks (UAF)</a>.</p>
